    ...
    <div className='pagdiv'>
        ...
        <div className='flex'>
            <img style={!currentPageIndex?{visibility:"hidden"}:null} 
                onClick={()=>onPageClick({queryName:"skip", queryValue:currentPageIndex-1})}
            ...
            {paginationRange.map((pInd,ind)=>
                ...
                {(pInd === 'skip')?
                    <p>...</p>:
                    <p style={{cursor:"pointer"}} onClick={pInd===currentPageIndex+1?null:()=>onPageClick({queryName:"skip", queryValue:pInd-1})}
